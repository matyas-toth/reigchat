    ...
    <div className="flex min-h-dvh items-center justify-center bg-background p-4">
      <div className="w-full max-w-[400px] space-y-8">
        <div className="space-y-2 text-center">
          <h1 className="text-3xl font-semibold tracking-tight">Hozd létre a friss, új fiókodat</h1>
          <p className="text-sm text-muted-foreground">
            Millió kaland vár rád
          </p>
        </div>
        ...
        <div className="flex flex-col gap-3">
          <Button variant="outline" className="h-12 w-full relative group" onClick={() => handleSocialLogin("google")}>
            ...
            <span className="font-medium text-sm">Regisztráció Google fiókkal</span>
          </Button>
          <Button variant="outline" className="h-12 w-full relative group" onClick={() => handleSocialLogin("github")}>
            ...
            <span className="font-medium text-sm">Regisztráció GitHub fiókkal</span>
          </Button>
          <Button variant="outline" className="h-12 w-full relative group" onClick={() => handleSocialLogin("discord")}>
            ...
            <span className="font-medium text-sm">Regisztráció Discord fiókkal</span>
          </Button>
        </div>
